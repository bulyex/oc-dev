...
INSERT INTO "new_Cycle" ("completedAt", "currentWeek", "goalsText", "id", "planText", "startedAt", "status", "userId", "visionText", "weekCount") SELECT "completedAt", "currentWeek", "goalsText", "id", "planText", "startedAt", "status", "userId", "visionText", "weekCount" FROM "Cycle";
DROP TABLE "Cycle";
