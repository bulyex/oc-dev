 ...
 */
export const VISION_WELCOME_MESSAGE = `Видение — это не список целей. Это описание того, как ты себя чувствуешь, когда всё складывается.

Не «похудеть на 10 кг», а «тело лёгкое, энергии хватает на весь день». Не «запустить проект», а «я в потоке — работа идёт сама».

Через 12 недель ты уже можешь быть в этом состоянии. Давай выясним, каким именно оно для тебя.

Какие сферы жизни сейчас для тебя наиболее важны? Можешь перечислить — хоть одну, хоть несколько.`;
